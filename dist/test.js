...
const MerkleManager_1 = require("./MerkleManager"); // Ensure this import path is correct based on your project structure
/**
 ...
 */
const addDirectory = (manager_1, dirPath_1, ...args_1) => __awaiter(void 0, [manager_1, dirPath_1, ...args_1], void 0, function* (manager, dirPath, baseDir = dirPath) {
    const files = fs.readdirSync(dirPath);
    for (const file of files) {
        const filePath = path.join(dirPath, file);
        const stat = fs.statSync(filePath);
        if (stat.isDirectory()) {
            yield addDirectory(manager, filePath, baseDir);
        }
        else {
...
const manager = new MerkleManager_1.MerkleManager(storeId);
...
addDirectory(manager, folderPath)
    ...
    const sha256 = (_a = manager.files.get(keyToStream)) === null || _a === void 0 ? void 0 : _a.sha256;
    if (sha256) {
